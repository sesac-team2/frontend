...
export interface SocialConnection {
  ...
  connected: boolean;
  email: string | null;
  icon: ReactNode; // Note: We might need to handle the icons carefully if they are JSX
}

// Since we are moving this to a pure TS/TSX file, we can keep the JSX for icons if we import React/types
// However, typically data files might just have data. For now, I'll keep it as is since it's being used directly in UI.
// But better to componentize the icons or imports.
// The original file had inline SVGs. I will copy them here.
